# 🔴 겸용 펌프 용량 계산서 — 간이스프링클러 + 옥내소화전 · **Ver 5.0**

> **Developer MANMIN** | ㈜대성건축사사무소
> MANMIN WAP 디자인 통일 · 소방 계열 06.
...
```
옥내간이겸용_{공사명}_{YYYYMMDD}[_n].jpg     페이지당 1588 × 2246px (scale 2)
```
...
| **NFPC / NFTC 103A** 간이스프링클러설비 | **제2025-25호 · 2026.3.1 시행** | 제5조 방수압력·방수량 |

> **개정 영향 없음.** 양 기준 모두 계산 조항은 개정되지 않았다.

#### ⚠️ 적용 대상 판단 — 103A 제14조 신설

**주택전용 간이스프링클러**(연립주택·다세대주택)는 **가압송수장치를 적용하지 않을 수 있다**(제14조 5호).
해당 대상이면 겸용 펌프 산정 자체가 성립하지 않으므로 **적용 대상을 먼저 확인할 것.**
