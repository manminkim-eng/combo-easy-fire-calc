...
const CACHE_NAME   = 'manmin-ganji-indoor-v5.0.6';
const STATIC_CACHE = 'manmin-ganji-indoor-static-v5.0.6';
...
self.addEventListener('install', (event) => {
  console.log('[SW] Installing ganji-indoor-v5.0...');
  event.waitUntil(
